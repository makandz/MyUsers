...
//Retrieve a list of all .php files in include/languages
function getLanguageFiles()
{
	$directory = "include/language-templates/";
	$languages = glob($directory . "*.php");
	//print each file name
	return $languages;
}

//Retrieve a list of all .css files in include/site-templates 
function getTemplateFiles()
{
	$directory = "include/css-templates/";
...
function resultBlock($errors,$successes){
	...
	if(count($errors) > 0)
	{
		echo "<div class='mainError' id='error'>
	...
	{
		echo "<div class='mainSuccess' id='success'>
